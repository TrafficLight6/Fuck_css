...
<body>
    ...
    <a href="..">返回</a>
    <hr>
    <p>本站管理员将会尽可能审核你的申请，至多48小时将会出审核结果，审核结果将以邮箱的形式通知你</p>
    <a href="../permanent_page/lib/how-join-in/" target="_blank">加入本站详细信息</a>
    <h4>请勿提交多份申请</h4>
    
    <form name="signup" method="post" onsubmit="return mycheak()" action="../function_lib/submit_signup.php">
    <p>用户名（除特殊情况外，加入本站后不得改名）<input name="username" type="text" size="30" maxlength="30">(上限为30个字符)</p>
    <p>邮箱<input name="email" type="text" size="30">(上限为255个字符)</p>    
    <p>密码<input name="pwd" type="password" size="30"></p>
    ...
    <p>提交申请即代表同意用户协议<a href="../permanent_page/lib/deal/"><h2>用户协议</h2></a></p>
    <p><input type="submit" value="提交且同意本站站规"></p>
    </form>

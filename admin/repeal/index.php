...
<body>
    ...
    <!------------------------------------------------->
    <?php
        $dir=scandir("../../permanent_page/lib/repeal/report");
        foreach($dir as $value){
            ...
            if (($value==".")or($value=="..")or($value=="total.fcdb")){
                ...
                $fopen_n=fopen('../../permanent_page/lib/repeal/report/'.$value."/username.fcr",'r');
                $username=fgets($fopen_n);                      //echo是谁的申诉
                fclose($fopen_n);
                
                echo '<p><a href="read?r_id='.$value.'&un='.$username.'">'.$username.'的申诉</a></p>';
            }
        }
    ?>
</body>
